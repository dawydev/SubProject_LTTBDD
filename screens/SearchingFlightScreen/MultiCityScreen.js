    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={{marginLeft: 20, alignSelf: 'flex-start' }}>
                <Text style={{fontSize: 18, marginBottom: 15, fontWeight: "600"}}>Flight 1</Text>
            </View>
                    {/* From and To */}
            ...
            {/* Flight 2 */}
            <View style={{marginLeft: 20, alignSelf: 'flex-start' }}>
                <Text style={{fontSize: 18, marginBottom: 15, fontWeight: "600", marginTop: 20}}>Flight 2</Text>
            </View>
                    {/* From and To */}
                <View style={styles.fromToContainer}>
                    {/* From */}
